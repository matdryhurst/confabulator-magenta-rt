...
### [CONFABULATOR (App)](collider.md)
Mix prompt balls, audio embeddings, model controls, RVQ token manipulation, and output damage in a self-contained standalone app.
...
| CONFABULATOR      | `deploy_mrt2_collider`   | `~/Applications/CONFABULATOR.app`    |
