...
public:
    ...
    void set_rvq_force(float v) { engine_.set_rvq_force(v); }
    float get_rvq_force() const { return engine_.get_rvq_force(); }
    void set_rvq_breathe(float v) { engine_.set_rvq_breathe(v); }
    float get_rvq_breathe() const { return engine_.get_rvq_breathe(); }
    void set_rvq_memory(float v) { engine_.set_rvq_memory(v); }
    float get_rvq_memory() const { return engine_.get_rvq_memory(); }
    void set_rvq_coarse(float v) { engine_.set_rvq_coarse(v); }
    float get_rvq_coarse() const { return engine_.get_rvq_coarse(); }
    void set_rvq_fine(float v) { engine_.set_rvq_fine(v); }
    float get_rvq_fine() const { return engine_.get_rvq_fine(); }
    void set_rvq_sweep(float v) { engine_.set_rvq_sweep(v); }
    float get_rvq_sweep() const { return engine_.get_rvq_sweep(); }
    void set_rvq_hold(float v) { engine_.set_rvq_hold(v); }
    float get_rvq_hold() const { return engine_.get_rvq_hold(); }
    void set_rvq_invert(float v) { engine_.set_rvq_invert(v); }
    float get_rvq_invert() const { return engine_.get_rvq_invert(); }
    void set_rvq_jitter(float v) { engine_.set_rvq_jitter(v); }
    float get_rvq_jitter() const { return engine_.get_rvq_jitter(); }
    void set_rvq_stride(float v) { engine_.set_rvq_stride(v); }
    float get_rvq_stride() const { return engine_.get_rvq_stride(); }
    /// @}
    ...
    bool get_prompt_embedding(int index, float* out) const {
        return engine_.get_prompt_embedding(index, out);
    }
    /// @}
